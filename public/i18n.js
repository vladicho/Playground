...
const PT_TO_ES = new Map([
  ...
  ["🎙️ Usar áudio próprio", "🎙️ Usar audio propio"],
  ["Áudio escolhido", "Audio elegido"],
  ["Áudio próprio escolhido. Ele será usado na videoaula.", "Audio propio seleccionado. Se usará en la videoclase."],
  ...
  ["Montando videoaula com seu áudio… mantenha esta tela aberta.", "Creando videoclase con tu audio… mantén esta pantalla abierta."],
  ["Montando videoaula sem áudio… mantenha esta tela aberta.", "Creando videoclase sin audio… mantén esta pantalla abierta."],
  ...
  ["Este navegador não consegue gerar o vídeo.", "Este navegador no puede generar el video."],
  ["Este navegador não consegue usar o áudio escolhido.", "Este navegador no puede usar el audio seleccionado."],
  ...
  ["▶ Ouvir com ElevenLabs", "▶ Escuchar con ElevenLabs"],
  ["Áudio pronto com ElevenLabs.", "Audio listo con ElevenLabs."],
  ["A narração mudou de provedor durante a geração. Tente novamente.", "La narración cambió de proveedor durante la generación. Inténtalo de nuevo."],
